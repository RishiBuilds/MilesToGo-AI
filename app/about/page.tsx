  ...
  return (
    <section className="py-16 bg-white dark:bg-neutral-950 text-neutral-900 dark:text-neutral-100">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-12">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
          <div className="lg:col-span-7 space-y-6">
            ...
            <p className="text-base text-neutral-600 dark:text-neutral-300 max-w-2xl">
              MilesToGo AI blends smart automation and local knowledge to design
        ...
        <div id="how" className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {features.map((f, i) => {
            ...
            return (
              <div
                key={i}
                className={`rounded-2xl p-6 shadow-sm border border-gray-100 dark:border-neutral-800 bg-linear-to-br ${f.color}`}
              >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <aside className="rounded-2xl p-6 bg-gray-50 dark:bg-neutral-900/40 border border-gray-100 dark:border-neutral-800">
            ...
            <blockquote className="mt-4 text-sm text-neutral-700 dark:text-neutral-300">
              “MilesToGo AI turned a vague idea into a full, walkable itinerary
        ...
        {/* FOOTER CTA */}
        <div className="rounded-2xl p-6 bg-linear-to-r from-orange-50 to-white dark:from-neutral-900/40 border border-gray-100 dark:border-neutral-800 text-center">
