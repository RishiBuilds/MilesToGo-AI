    ...
    <section className="w-full bg-white dark:bg-neutral-950 text-neutral-900 dark:text-neutral-100 py-12">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
          {/* Left: contact form */}
          <div className="lg:col-span-7 bg-linear-to-b from-white to-orange-50 dark:from-neutral-900 dark:to-neutral-950 rounded-2xl p-6 sm:p-8 shadow-md">
          ...
          <aside className="lg:col-span-5 flex flex-col gap-6">
            ...
            <div className="rounded-2xl p-6 bg-gray-50 dark:bg-neutral-900/60 border border-gray-100 dark:border-neutral-800 flex flex-col gap-4">
              ...
              <div className="flex items-center gap-4">
                <a href="https://www.facebook.com/profile.php?id=10u636636363636" className="text-gray-600 hover:text-blue-600">
                  <FaFacebook size={20} />
                </a>
                <a href="https://x.com/KingRishi2005" className="text-gray-600 hover:text-sky-400">
                  <FaTwitter size={20} />
                </a>
                <a href="https://www.instagram.com/rishi_chaurasia_192" className="text-gray-600 hover:text-pink-500">
                  <FaInstagram size={20} />
                </a>
                <a href="https://www.linkedin.com/in/rishi_chaurasiya" className="text-gray-600 hover:text-blue-700">
                  <FaLinkedin size={20} />
                </a>
              </div>
