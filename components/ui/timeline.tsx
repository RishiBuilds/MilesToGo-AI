    ...
    >
      ...
      <div ref={ref} className="relative max-w-7xl mx-auto pb-20">
        ...
        <div
          ...
          className="absolute left-4 md:left-12 top-0 w-2px bg-[linear-gradient(to_bottom,var(--tw-gradient-stops))] from-transparent from-0% via-neutral-200 dark:via-neutral-700 to-transparent to-99% mask-[linear-gradient(to_bottom,transparent_0%,black_10%,black_90%,transparent_100%)]"
        >
          <motion.div
            style={{
            ...
            className="absolute inset-x-0 top-0 w-2px bg-linear-to-t from-purple-500 via-blue-500 to-transparent rounded-full"
          />
        </div>
      </div>
    </div>
